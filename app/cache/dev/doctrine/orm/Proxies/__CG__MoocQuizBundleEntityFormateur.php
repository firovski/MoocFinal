 ...
 */
class Formateur extends \Mooc\QuizBundle\Entity\Formateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mooc\\QuizBundle\\Entity\\Formateur' . "\0" . 'id', '' . "\0" . 'Mooc\\QuizBundle\\Entity\\Formateur' . "\0" . 'nom');
        }
