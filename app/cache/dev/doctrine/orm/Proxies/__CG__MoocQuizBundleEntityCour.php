 ...
 */
class Cour extends \Mooc\QuizBundle\Entity\Cour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mooc\\QuizBundle\\Entity\\Cour' . "\0" . 'id', '' . "\0" . 'Mooc\\QuizBundle\\Entity\\Cour' . "\0" . 'nom');
        }
